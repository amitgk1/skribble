...
class Game:
    def __init__(self):
        ...
        # Drawing state
        self.lines = []  # This will store all line segments to be drawn
        self.is_drawing = False
        self.last_pos = None
    ...
    def next_round(self):
        if self.round < self.total_rounds:
            ...
            self.lines = []  # Clear all line segments
                ...
                if self.is_drawing and self.drawing_enabled:
                    ...
                    if (
                        ...
                        if self.last_pos:
                            ...
                            # Add a new line segment to our list of lines
                            self.lines.append(
                                LineSegment(
                                    self.last_pos,
                                    current_pos,
    ...
    def draw(self, screen: pygame.Surface):
        ...
        # Create a drawing surface for the canvas
        drawing_surface = pygame.Surface((DRAWING_AREA_WIDTH, DRAWING_AREA_HEIGHT))
        drawing_surface.fill((255, 255, 255))

        # Draw all line segments onto the drawing surface
        ...
        screen.blit(drawing_surface, (DRAWING_AREA_LEFT, DRAWING_AREA_TOP))
